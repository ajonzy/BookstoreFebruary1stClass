...
export default class BookDetails extends Component {
   ...
   componentDidMount() {
       fetch(`https://aoj-book-app-api-february1st.herokuapp.com/book/get/${this.props.match.params.id}`)
   ...
   handleChange(event) {
    ...
    handleSubmit(event) {
        ...
        fetch(`https://aoj-book-app-api-february1st.herokuapp.com/book/update/${this.props.match.params.id}`, {
            method: "PUT",
    ...
    handleDelete() {
        fetch(`https://aoj-book-app-api-february1st.herokuapp.com/book/delete/${this.props.match.params.id}`, {
            method: "DELETE"
        })
        .then(response => response.json())
        .then(data => {
